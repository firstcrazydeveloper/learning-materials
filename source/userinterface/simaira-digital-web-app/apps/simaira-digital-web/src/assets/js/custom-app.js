(function($){
    ...
    */
    ...
    /* For navbar with top bar */
    function mainNav60() {
        var top = (document.documentElement && document.documentElement.scrollTop) || document.body.scrollTop;
        if (top > 40) {
            if($('.global-navigation').length > 0) $('.sticky-navigation').stop().animate({"top": '-60'});
            else if($('.app-land-nav').length > 0) {
                $('.sticky-navigation').stop().animate({"top": '0'});
                $('.sticky-navigation').css("background", "linear-gradient(90deg,hsla(0,0%,93%,0),#ececec 15%,#ececec 85%,hsla(0,0%,93%,0))");
            }
            else $('.sticky-navigation').stop().animate({"top": '0'});
        }
        else {
            if($('.global-navigation').length > 0) $('.sticky-navigation').stop().animate({"top": '0'});
            else if($('.app-land-nav').length > 0) {
                $('.sticky-navigation').stop().animate({"top": '0'});
                $('.sticky-navigation').css("background", "#ffffff");
            }
    ...
    function mainNav120() {
        var top = (document.documentElement && document.documentElement.scrollTop) || document.body.scrollTop;
        if (top > 40) {
            if($('.global-navigation').length > 0) $('.sticky-navigation').stop().animate({"top": '-120'});
            else if($('.app-land-nav').length > 0) {
                $('.sticky-navigation').stop().animate({"top": '0'});
                $('.sticky-navigation').css("background", "linear-gradient(90deg,hsla(0,0%,93%,0),#ececec 15%,#ececec 85%,hsla(0,0%,93%,0))");
            }
